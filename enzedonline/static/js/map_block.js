...
async function getRoute(coord_list) {
  ...
  document.getElementById("distance-" + uid).innerText = (Math.round(data.distance/100) / 10).toFixed(1);
  document.getElementById("hours-" + uid).innerText = (Math.round(data.duration/360) / 10).toFixed(1);
