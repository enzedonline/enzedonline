export class RecipeListing {
    ...
    constructor(baseUrl) {
        ...
        this.tagListContainer = document.getElementById('recipe-taglist');
        this.recipeCardList = document.getElementById('recipe-card-list');
        this.filterItems = document.querySelector('div.recipe-filter-items');
        this.offCanvas = bootstrap.Offcanvas.getOrCreateInstance(document.querySelector('div.recipe-offcanvas'));
        this.clearBtn = document.getElementById('clear-filter-btn');
        this.applyBtn = document.getElementById('apply-filter-btn');
        this.searchForm = document.getElementById('search-recipes-form');
        this.searchInput = document.getElementById('search-recipes-input');
        this.getTagList();
        this.getActiveTags();
    ...
    tagListClickHandler = (e) => {
        ...
        const deleteBtn = target.closest('.recipe-tag-item-delete');
        if (deleteBtn) {
            const tagItem = target.closest('.recipe-tag-item');
